...
This table now supports two request types:
...
An employee selects a completed shift.
The employee submits corrected clock-in and clock-out times with a reason.
The request appears in the manager dashboard.
The manager approves or rejects it.
Approval updates the original shift.
The correction request remains as an audit record.

## Employees cannot directly edit payroll records.

Missed shift request workflow
An employee selects the missed shift option.
The employee enters the missed clock-in time, missed clock-out time, and a reason.
The request appears in the manager dashboard.
The manager approves or rejects it.
Approval creates a new time entry.
The missed shift request remains as an audit record.
